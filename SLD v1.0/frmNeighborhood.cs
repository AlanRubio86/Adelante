...
namespace SLD_v1._0
{
    public partial class frmNeighborhood : BaseForm
    {
        public frmNeighborhood()
        {
            InitializeComponent();
        }
        ...
        public void EditAndInsert(string psMensage, string psTitulo, int piEstado)
        {
            ...
            try
            {
                ...
                pars[7] = new SqlParameter("@Direccion", txtDireccion.Text);
        ...
        public void llenaRenglon(DataGridViewRow drDatos)
        {
            ...
            txtDireccion.Text = drDatos.Cells["colDireccion"].Value.ToString();
        ...
        public void Habilitar(bool pbHabilita)
        {
            ...
            txtDireccion.Enabled = pbHabilita;
